...
############################################################
deathwave <- read.csv(
  "data/deathdata_Osaka_wave.csv",
  header = TRUE,
  row.names = 1
)
deathwave1<-as.numeric(deathwave[1,])
deathwave2<-as.numeric(deathwave[2,])
deathwave3<-as.numeric(deathwave[3,])
deathwave4<-as.numeric(deathwave[4,])
deathwave5<-as.numeric(deathwave[5,])

infwave <- read.csv(
  "data/Infdata_Osaka_wave.csv",
  header = TRUE,
  row.names = 1
)
infwave1<-as.numeric(infwave[1,])
infwave2<-as.numeric(infwave[2,])
infwave3<-as.numeric(infwave[3,])
infwave4<-as.numeric(infwave[4,])
infwave5<-as.numeric(infwave[5,])
